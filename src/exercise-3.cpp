...
const char *fragmentShaderSource1 = "#version 330 core\n"
                                   ...
                                   "void main()\n"
                                   "{\n"
                                   "   FragColor = vec4(0.7f, 0.8f, 0.4f, 1.0f);\n"
                                   "}\n\0";
...
int main()
{
    ...
    // checking for compile errors in another fragment shader
    ...
    // checking for linking errors in another shader program
